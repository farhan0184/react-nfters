...
const HomeLeft = () => {
    return (
        <div className='md:w-[60%] '>
            ...
            <p className='w-[62%] text-xl md:mb-10 mb-5'>Digital marketplace for crypto collectibles and non-fungible tokens (NFTs). Buy, Sell, and discover exclusive digital assets.</p>
